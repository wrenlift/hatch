...
#!native
import "gpu_native" for GpuCore, Gpu, Device, Buffer, ShaderModule, Shader, Texture, TextureView, Sampler, BindGroupLayout, PipelineLayout, BindGroup, RenderPipeline, CommandEncoder, RenderPass, Camera2D, Renderer2D, Sprite, Camera3D, Light, Mesh, Material, Renderer3D, LivePipeline, Surface, SurfaceFrame

#!wasm
import "gpu_web" for GpuCore, Gpu, Device, Buffer, ShaderModule, Shader, Texture, TextureView, Sampler, BindGroupLayout, PipelineLayout, BindGroup, RenderPipeline, CommandEncoder, RenderPass, Camera2D, Renderer2D, Sprite, Camera3D, Light, Mesh, Material, Renderer3D, LivePipeline, Surface, SurfaceFrame
